<template>
  ...
  <div style="display: flex">
    <div class="image-box">
      <img style="width: 100%;" src="http://www.e3ol.com/biography/pic/id/240/19.jpg" alt="">
    </div>
    <div class="text-box">
      <h2>刘禅追谥尚欠赵云一个正点</h2>
