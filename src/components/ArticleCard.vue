...
<script>
  export default {
    ...
    props: {
      ...
      image: {
        type: String,
        default: 'http://www.e3ol.com/biography/pic/id/240/19.jpg'
      },
      time: {
        type: String,
        default: '2020-04-01'
      ...
      describe: {
        type: String,
        default: '君主时代帝王死后，会依据他生前的所作所为给他一个定性类的称号，' +
